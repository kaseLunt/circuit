...
| --- | --- | --- | --- | --- | --- |
| W01 | P0 bootstrap — scaffold, CI, spikes, and pinned decisions | P0 | — | ci-green-scaffold-plus-executable-sandbox-proof | superseded |
...
| W04 | Disposition the P0→P1 boundary review findings | P0 | — | boundary-review-blockers-cleared-and-reconfirmed | active |

The rows above project `work/W01-p0-bootstrap.md`, `work/W02-founding-docs.md`, and
`work/W03-p1-finance-core.md`, and `work/W04-boundary-review-remediation.md`. Work objects are created when their phase approaches, not
